...
drop policy if exists "equipe exclui servicos sem vinculos" on public.servicos;
create policy "equipe exclui servicos sem vinculos" on public.servicos for delete using (public.eh_equipe_empresa(empresa_id));
