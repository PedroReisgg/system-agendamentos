...
export default function App(){
 ...
 if(page==='dashboard'&&usuario?.papel==='cliente')return <ClientDashboard supabase={supabase} usuario={usuario} servicos={servicosFront} onSair={sair} onInicio={()=>ir('inicio')} onAgendar={()=>ir('agendar','#agendar')} perfilInicial={location.hash==='#dashboard-perfil'}/>;
